...
export async function POST(request: NextRequest) {
  ...
  const config = await prisma.globalCostConfig.create({
    data: {
      ...
      vpsCostMonthly: data.vpsCostMonthly,
      dpbLicenseCostMonthly: data.dpbLicenseCostMonthly,
      otherFixedCostsMonthly: data.otherFixedCostsMonthly,
      otherVariableCostPerBot: data.otherVariableCostPerBot,
