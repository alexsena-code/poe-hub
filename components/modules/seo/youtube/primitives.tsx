...
// ---------------------------------------------------------------------------
// Shared micro-components used across YouTube Trends tabs.
// These are client-only because Tip uses useState + ref, and useSort uses
// useState — they have no meaningful server-side alternative.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Badge — lightweight inline colored chip
// ---------------------------------------------------------------------------

export function YtBadge({ children, className }: { children: React.ReactNode; className: string }) {
  return (
...
// ---------------------------------------------------------------------------
// Tip — hover tooltip anchored to the hovered element
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SortHeader — sortable <th> that toggles direction on click
// ---------------------------------------------------------------------------
